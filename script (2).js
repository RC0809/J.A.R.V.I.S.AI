  ...
  chatSubmit.addEventListener("click", () => {
    ...
    if (message) {
      ...
      if (message.toLowerCase() === "what is temperature?") {
        setTimeout(() => {
          addMessage("The current temperature in Greater Noida, Uttar Pradesh, India, is approximately 26°C (79°F) with sunny conditions.");
        }, 500);
      }
...
But hey, if I seem too real, I'll take that as a compliment! 😄`);
        ...
        setTimeout(() => {
          addMessage("As of 2025, the Prime Minister of India is Shri Narendra Modi. He assumed office for his third term on June 9, 2024, following a decisive victory in the 2024 Parliamentary elections. ");
        }, 500);
      } 
      else {
        // Default AI response
  ...
  learnMoreBtn.addEventListener("click", (e) => {
    e.preventDefault()
    // Create a modal to display information about J.A.R.V.I.S
